...
class TopoOF13(Topo):
    def build(self):
       ...
       # s2 = self.addSwitch('s2', protocols='OpenFlow13')
        ...
        # Switch interconnection - higher bandwidth
        # Using r2q=100 for 100Mbps link - scales with bandwidth
...
def configure_switch_of13(switch):
    ...
    # Configure QoS with adjusted rates for different port types
    for port in range(1, 5):
        cmd = f'''ovs-vsctl -- \
