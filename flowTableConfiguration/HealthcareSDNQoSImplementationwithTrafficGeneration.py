...
def createHealthcareNetwork():
    ...
    net.addLink(monitoring, s1, cls=TCLink, bw=15, delay='5ms', max_queue_size=1000)
    net.addLink(imaging, s1, cls=TCLink, bw=15, delay='10ms', max_queue_size=1000)
    ...
    net.addLink(server, s3, cls=TCLink, bw=15, delay='1ms', max_queue_size=1000)
